...
import com.lichao.oksockettest.data.MsgDataBean;
...
public class MainActivity extends AppCompatActivity implements IClientIOCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAndroidSocket = findViewById(R.id.btn4);
        ...
        mAdminBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, ServerAdminActivity.class);
                startActivity(intent);
            }
        });

        mAndroidSocket.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, AndroidSocketActivity.class);
                startActivity(intent);
            }
        });
        ...
        mServerManager = OkSocket.server(mPort).registerReceiver(new ServerActionAdapter() {
            ...
            public void onClientDisconnected(IClient client, int serverPort, IClientPool clientPool) {
                ...
                client.removeIOCallback(MainActivity.this);
            }
