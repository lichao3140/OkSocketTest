package com.lichao.oksockettest.androidsocket;
...
public class MySocketServer {
    final MySocketServer self = this;
...
//            __i__setupReadManuallyForReceiver(this.socketServer);
    ...
    protected MySocketServer setServerListeningSocketServerClient(SocketServerClient serverListeningSocketServerClient) {
    ...
    private MySocketClient testClient;
    protected MySocketClient getMySocketClient() {
        if (this.testClient == null) {
            this.testClient = new MySocketClient();
        }
